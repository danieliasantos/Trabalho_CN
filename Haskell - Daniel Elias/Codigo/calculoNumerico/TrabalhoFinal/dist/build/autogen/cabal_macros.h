...
/* package TrabalhoFinal-0.0.1 */
#define VERSION_TrabalhoFinal "0.0.1"
#define MIN_VERSION_TrabalhoFinal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
/* package ansi-terminal-0.8 */
#define VERSION_ansi_terminal "0.8"
...
#define CURRENT_COMPONENT_ID "TrabalhoFinal-0.0.1"

#define CURRENT_PACKAGE_KEY "TrabalhoFinal-0.0.1"
